...
MARK_HELPER = "ROTT64_R96C_SAVE_LOAD_AUDIO_GUARD_HELPER"
MARK_LOAD = "ROTT64_R96C_STOP_AUDIO_BEFORE_LOAD"
MARK_SAVE = "ROTT64_R96C_STOP_AUDIO_BEFORE_SAVE"
...
#endif
static void rott64_r96c_stop_audio_for_save_load(void)
{{
#ifdef __N64__
    MU_StopSong();
    SD_StopAllSounds();
...
def install_call(text: str, func: str, mark: str) -> str:
    ...
    /* {mark} */
    rott64_r96c_stop_audio_for_save_load();
#endif
"""
