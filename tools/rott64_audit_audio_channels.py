...
def main(argv: list[str]) -> int:
    if len(argv) != 2:
        raise SystemExit("ERROR: usage: r92b_audit_audio_channels.py generated/rott")
    ...
    if (mixer_channels, music_ch, music_sub) != (10, 8, 9):
        raise SystemExit("ERROR: unexpected r92b audio channel contract")
    ...
    print("PASS: ROTT64_R92B_AUDIO_CHANNEL_AUDIT")
