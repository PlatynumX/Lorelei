...
def main()->int:
    ...
    for needle, label in (
        ...
        ("tone_wave_read", "native MIDI sequencer tone waveform"),
        ("percussion_wave_read", "native MIDI sequencer percussion waveform"),
        ("mixer_ch_set_freq", "native MIDI mixer pitch control"),
        ("mixer_ch_set_vol", "native MIDI mixer volume control"),
        ("rott64_music_pump", "native MIDI incremental event pump"),
