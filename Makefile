...
# Full Dark War enables legacy Taradino code paths that produce numerous
# GCC 14 warnings. Keep warnings visible, but do not make warnings fatal for
# generated upstream engine objects. Native N64 platform code remains strict.
