# ROTT64 Revision 66 — Diagnostic Display Handoff Test (Shareware)
...
- Public ROM filename: `rott64-shareware-r66.z64`.

# ROTT64 Revision 61 — Restore Proven Libdragon Build Target (Shareware)
...
- The finished ROM is renamed only after a successful build to `rott64-shareware-r61.z64`.
- Shareware remains a dedicated build.
- Shareware preserves the exact R25 `-DSHAREWARE=1` runtime configuration.

- R25 rumble/audio baseline remains otherwise unchanged.

# ROTT64 Revision 59 — Dedicated The Hunt Begins (Shareware)

- Built from the exact R25 rumble baseline.
- Dedicated The Hunt Begins (Shareware) build.
- No runtime Shareware/Full selector.
- Output ROM filename: `rott64-shareware-r59.z64`.
