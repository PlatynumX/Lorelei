# ROTT64 Comm-Bat split-screen branch

- Forked from R28 into isolated `feature/splitscreen-commbat` development line.
- Added two-player local controller-slot and horizontal viewport scaffolding.
- Added `COMMBAT-SPLITSCREEN.md` milestone plan.
- Stable R28 music, rumble, EEPROM test, and homebrew header work remain the baseline.
